...
// v5.23.0 — snapshot + diff helpers live in firestoreScheduleSnapshots.ts.
// Re-exported here so existing import paths keep working without churn at
// the call sites.
export {
  getLatestSnapshot,
  summarizeDiffMap,
  diffScheduleVsSnapshot,
} from './firestoreScheduleSnapshots';
export type {
  ScheduleSnapshot,
  ScheduleDiffKind,
  ScheduleDiffMap,
