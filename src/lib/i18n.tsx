...
export const en: Dict = {
  ...
  'planAll.back': 'Back',
  'planAll.skip': 'Skip',
  'planAll.step.demand.title': 'Tune station demand from history',
  ...
  'planAll.demand.body': 'Reads observed coverage at each station across every saved schedule month and proposes a refreshed hourly demand profile. Useful when actual operations have drifted from the configured numbers.',
  'planAll.demand.basis': '{months} month(s) · {normal} normal day(s) · {peak} peak day(s)',
  'planAll.demand.slots': 'Normal / peak slots',
  'planAll.demand.apply': 'Apply to {count} station(s)',
  'planAll.demand.noData': 'No usable history yet. Paint shifts or run the auto-scheduler for at least one month, then revisit.',
...
export const ar: Dict = {
  ...
  'planAll.back': 'رجوع',
  'planAll.skip': 'تخطّي',
  'planAll.step.demand.title': 'ضبط طلب المحطات من السجل',
  ...
  'planAll.demand.body': 'يقرأ التغطية الفعلية لكل محطة عبر جميع أشهر الجداول المحفوظة ويقترح ملف طلب ساعي محدّثاً. مفيد عندما تنحرف العمليات الفعلية عن الأرقام المُكوَّنة.',
  'planAll.demand.basis': '{months} شهر · {normal} يوم عادي · {peak} يوم ذروة',
  'planAll.demand.slots': 'الفترات (عادي / ذروة)',
  'planAll.demand.apply': 'طبّق على {count} محطة',
  'planAll.demand.noData': 'لا يوجد سجل قابل للاستخدام بعد. ارسم مناوبات أو شغّل الجدولة لشهر واحد على الأقل ثم عُد.',
