...
export const en: Dict = {
  ...
  'schedule.filter.groupByStation.tooltip': 'Cluster rows by each employee\'s primary station (the one they\'re assigned to most often this month).',
  ...
  'workforce.forecast.banner.skippedMovable': '{count} movable holiday(s) couldn\'t be auto-projected to {year} (Hijri-based dates need manual entry — add them in the Holidays tab for accurate forecasts).',
...
export const ar: Dict = {
  ...
  'schedule.filter.groupByStation.tooltip': 'تجميع الصفوف حسب المحطة الأساسية لكل موظف (التي يُكلّف بها أكثر هذا الشهر).',
  ...
  'workforce.rollup.title': 'الملخص السنوي — توصية لكل دور',
  ...
  'workforce.forecast.banner.skippedMovable': 'تعذّر إسقاط {count} عيد متحرّك تلقائيًا إلى {year} (التواريخ الهجرية تحتاج إدخالًا يدويًا — أضفها في علامة الأعياد للحصول على توقّعات دقيقة).',
