...
export const en: Dict = {
  ...
  'holidays.compMode.cycleHint': 'Click to cycle: inherit default → comp day → cash OT.',
  'holidays.compModeHint': 'Default Art. 74 mode is "{mode}". Click any holiday\'s pill to override that single day — useful when a peak week makes the comp-day rotation impossible and you need to pay 2× cash instead.',
  ...
  'variables.art74.subtitle': 'How holiday work is compensated: comp rest day or 2× cash premium.',
  'variables.art74.compDay.title': 'Comp Day (recommended)',
  ...
  'variables.art74.note': 'Per practitioner reading of Art. 74, the worker is owed EITHER a comp rest day OR the 2× premium — not both. Default mode applies to every holiday unless individually overridden in the Holidays tab. Comp days landed beyond the recommended threshold (still inside the maximum) surface a soft note for the supervisor.',
...
export const ar: Dict = {
  ...
  'holidays.compMode.cycleHint': 'انقر للتبديل: الوضع الافتراضي → يوم تعويض → بدل نقدي.',
  'holidays.compModeHint': 'الوضع الافتراضي للمادة ٧٤ هو "{mode}". انقر على شارة أي عطلة لاستثنائها — مفيد إذا كان أسبوع العمل مزدحمًا ولا يمكن تدوير يوم تعويض، فيتم دفع ٢× نقدًا بدلًا منه.',
  ...
  'variables.art74.subtitle': 'كيف يُعوَّض العمل في العطلة: يوم راحة تعويضي أم بدل نقدي ٢×.',
  'variables.art74.compDay.title': 'يوم تعويضي (موصى به)',
  ...
  'variables.art74.note': 'وفق قراءة بعض الفقهاء للمادة ٧٤، يستحق العامل إما يوم راحة تعويضي أو علاوة ٢× نقدًا — لا الاثنين. يُطبَّق الوضع الافتراضي على كل عطلة ما لم يُستثنَ يدويًا في تبويب العطلات. أيام التعويض التي تتجاوز الحد الموصى به (لكنها ضمن الحد الأقصى) تظهر كملاحظة استرشادية للمشرف.',
